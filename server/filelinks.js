if (Meteor.isServer) {
	...
	var walkThruFilelinks = function (){
    ...
    walkThruFilelinks: function () {
				...
				var validatedFilesPath = rkSettings.findOne({key: "validatedFilesPath"}).value
				//they can be separated by | :
				var validatedFilesPathArray = validatedFilesPath.split("|");
