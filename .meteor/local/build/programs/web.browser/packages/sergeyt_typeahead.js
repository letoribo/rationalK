...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/sergeyt:typeahead/typeahead.bundle.js                                                                   //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
/*!                                                                                                                 // 1
...
(function(root, factory) {                                                                                          // 7
    ...
    var Transport = function() {                                                                                    // 342
        "use strict";                                                                                               // 343
        var pendingRequestsCount = 0, pendingRequests = {}, maxPendingRequests = 6, sharedCache = new LruCache(10); // 344
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                                  //
// packages/sergeyt:typeahead/index.js                                                                              //
//                                                                                                                  //
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                    //
	...
	if (datasets) {                                                                                                    // 138
		...
		return datasets.map(function(ds) {                                                                                // 145
			return make_bloodhound(ds);                                                                                      // 146
                                                                                                                    ...
                                                                                                                    // 149
	var name = normalize_dataset_name($e.attr('name') || $e.attr('id') || 'dataset');                                  // 150
...
function resolve_template_function(element, name) {                                                                 // 288
	var fn = null;                                                                                                     // 289
	// traver view hierarchy and find helper function                                                                  // 290
	var view = Blaze.getView(element);                                                                                 // 291
	while (view) {                                                                                                     // 292
		if (view.template) {                                                                                              // 293
			fn = Blaze._getTemplateHelper(view.template, name);                                                              // 294
	...
	function invoke(args) {                                                                                            // 307
		// internal function which sets the instance before calling our function                                          // 308
		return Template._withTemplateInstanceFunc(                                                                        // 309
			function() { return view.templateInstance(); },                                                                  // 310
			function() { return fn.apply(view.templateInstance(), args); }                                                   // 311
		);                                                                                                                // 312
	}                                                                                                                  // 313
                                                                                                                    // 314
	if (fn.length === 0) { // local dataset?                                                                           // 315
		return function() {                                                                                               // 316
	...
	return function(a) {                                                                                               // 321
		return invoke(Array.prototype.slice.call(arguments));                                                             // 322
                                                                                                                    ...
                                                                                                                    // 325
// Returns HTML template function that generates HTML string using data from suggestion item.                       // 326
// This function is implemented using given meteor template specified by templateName argument.                     // 327
function make_template_function(templateName) {                                                                     // 328
	if (!templateName) {                                                                                               // 329
		throw new Error("templateName is not specified");                                                                 // 330
	}                                                                                                                  // 331
                                                                                                                    // 332
	var tmpl = Template[templateName];                                                                                 // 333
	if (!tmpl) {                                                                                                       // 334
		throw new Error("Template '" + templateName  + "' is not defined");                                               // 335
	}                                                                                                                  // 336
                                                                                                                    // 337
	return function(context) {                                                                                         // 338
		var div = $("<div/>");                                                                                            // 339
		if ($.isFunction(Blaze.renderWithData)) {                                                                         // 340
			Blaze.renderWithData(tmpl, context, div[0]);                                                                     // 341
		} else { // for meteor < v0.9                                                                                     // 342
			var range = UI.renderWithData(tmpl, context);                                                                    // 343
			UI.insert(range, div[0]);                                                                                        // 344
		}                                                                                                                 // 345
		// return html wrapped into div to avoid visual issues                                                            // 346
		return div[0].outerHTML;                                                                                          // 347
	};                                                                                                                 // 348
}                                                                                                                   // 349
                                                                                                                    // 350
// Creates object with template functions (for header, footer, suggestion, empty templates).                        // 351
function make_templates(dataset) {                                                                                  // 352
                                                                                                                    // 353
	function make(value) {                                                                                             // 354
		if (!value) {                                                                                                     // 355
			return null;                                                                                                     // 356
		}                                                                                                                 // 357
		if (typeof value === "string") {                                                                                  // 358
			if (value.indexOf('<') >= 0) { // detect HTML string                                                             // 359
				return value;                                                                                                   // 360
			}                                                                                                                // 361
			return make_template_function(value);                                                                            // 362
		}                                                                                                                 // 363
		return $.isFunction(value) ? value : null;                                                                        // 364
	}                                                                                                                  // 365
                                                                                                                    // 366
	var templates = {                                                                                                  // 367
		header: make(dataset.header),                                                                                     // 368
		footer: make(dataset.footer),                                                                                     // 369
		suggestion: make(dataset.suggestion || dataset.template),                                                         // 370
		notFound: make(dataset.notFound || dataset.empty)                                                                 // 371
	};                                                                                                                 // 372
                                                                                                                    // 373
	return Object.keys(templates)                                                                                      // 374
		.filter(function(key) { return templates[key]; })                                                                 // 375
		.reduce(function(result, key) {                                                                                   // 376
			result[key] = templates[key];                                                                                    // 377
			return result;                                                                                                   // 378
		}, {});                                                                                                           // 379
}                                                                                                                   // 380
                                                                                                                    // 381
// Returns function to map string value to plain JS object required by typeahead.                                   // 382
function value_wrapper(dataset) {                                                                                   // 383
	return function(value) {                                                                                           // 384
		if (typeof value === 'object') {                                                                                  // 385
			return value;                                                                                                    // 386
		}                                                                                                                 // 387
		var item = {};                                                                                                    // 388
		item[dataset.valueKey] = value;                                                                                   // 389
		return item;                                                                                                      // 390
	};                                                                                                                 // 391
}                                                                                                                   // 392
                                                                                                                    // 393
// Creates Bloodhound suggestion engine based on given dataset.                                                     // 394
function make_bloodhound(dataset) {                                                                                 // 395
	if (!dataset.template) {                                                                                           // 396
		if (Array.isArray(dataset.local)) {                                                                               // 397
			dataset.local = dataset.local.map(value_wrapper(dataset));                                                       // 398
		} else if ($.isFunction(dataset.local) && dataset.local.length === 0) {                                           // 399
			var localFn = dataset.local;                                                                                     // 400
			dataset.local = function() {                                                                                     // 401
				return (localFn() || []).map(value_wrapper(dataset));                                                           // 402
			};                                                                                                               // 403
		}                                                                                                                 // 404
	}                                                                                                                  // 405
                                                                                                                    // 406
	var need_bloodhound = dataset.prefetch || Array.isArray(dataset.local) ||                                          // 407
		$.isFunction(dataset.local) && dataset.local.length === 0;                                                        // 408
                                                                                                                    // 409
	var engine;                                                                                                        // 410
                                                                                                                    // 411
	if (need_bloodhound) {                                                                                             // 412
		var options = $.extend({}, dataset, {                                                                             // 413
			// TODO support custom tokenizers                                                                                // 414
			datumTokenizer: Bloodhound.tokenizers.obj.whitespace(dataset.valueKey),                                          // 415
			queryTokenizer: Bloodhound.tokenizers.whitespace                                                                 // 416
		});                                                                                                               // 417
                                                                                                                    // 418
		engine = new Bloodhound(options);                                                                                 // 419
		engine.initialize();                                                                                              // 420
                                                                                                                    // 421
		if ($.isFunction(dataset.local) && dataset.local.length === 0) {                                                  // 422
			// update data source on changing deps of local function                                                         // 423
			// TODO find better (functional) way to do that                                                                  // 424
			var tracker = Template.instance() || Tracker;                                                                    // 425
			tracker.autorun(function(comp) {                                                                                 // 426
				// TODO stop tracking if typeahead is explicitly destroyed (issue #70)                                          // 427
				engine = new Bloodhound(options);                                                                               // 428
				engine.initialize();                                                                                            // 429
			});                                                                                                              // 430
		}                                                                                                                 // 431
	}                                                                                                                  // 432
                                                                                                                    // 433
	function bloodhound_source(query, cb) {                                                                            // 434
		var fn = engine.ttAdapter();                                                                                      // 435
		return fn(query, cb);                                                                                             // 436
	}                                                                                                                  // 437
                                                                                                                    // 438
	var src = need_bloodhound || typeof dataset.local !== 'undefined' ?                                                // 439
		{source: need_bloodhound ? bloodhound_source : dataset.local}                                                     // 440
		: {};                                                                                                             // 441
                                                                                                                    // 442
	var templates = typeof dataset.templates === 'undefined' ?                                                         // 443
		{templates: make_templates(dataset)}                                                                              // 444
		: {};                                                                                                             // 445
                                                                                                                    // 446
	return $.extend({}, dataset, src, templates);                                                                      // 447
}                                                                                                                   // 448
                                                                                                                    // 449
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
