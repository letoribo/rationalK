...
Router.route("/discussions", {
  name: "discussions",
  waitOn: function () {
    return [Meteor.subscribe("discussions"), Meteor.subscribe("messages"), Meteor.subscribe("members")];
  }
});
...
Router.route("/discussion/:_id", {
  ...
  waitOn: function () {
    return [Meteor.subscribe("discussion", this.params._id), Meteor.subscribe("messagesinthisdiscussion", this.params._id), Meteor.subscribe("members")];
  }
});
